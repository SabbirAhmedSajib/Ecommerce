	...
	<div id="content">
		<div class="container"><!--container Start-->
			...
			<div class="col-md-9">
				...
				<?php if(isset($_GET['edit_act'])){
				include("edit_act.php");}
				?>
				<!-- Including Edit Account.php End -->

				<!-- Including Change_pass.php Start -->
				<?php if(isset($_GET['change_pass'])){
				include("change_password.php");}
				?>
				<!-- Including Change_pass.php End -->

				<!-- Including delete.php Start -->
				<?php if(isset($_GET['delete_ac'])){
				include("delete_ac.php");}
				?>
				<!-- Including delete.php End -->
